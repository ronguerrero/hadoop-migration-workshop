...
# DBTITLE 1,The UDF returns the underlying java type. 
# MAGIC %md
# MAGIC 
...
spark.sql("DROP TEMPORARY FUNCTION IF EXISTS udftypeof")
spark.sql("CREATE TEMPORARY FUNCTION udftypeof AS 'com.mycompany.hiveudf.TypeOf'")

# COMMAND ----------

# DBTITLE 1,Let's display the java type
display(spark.sql("SELECT udftypeof(id) FROM raw_transactions limit 1"))
